...
from vllm.v1.kv_cache_interface import (KVCacheConfig, KVCacheGroupSpec,
                                        ...
                                        UniformTypeKVCacheSpecs,MambaSpec,AttentionSpec)
    ...
    if len(kv_cache_groups) == 1 and isinstance(
        ...
        for kv_cache_group in kv_cache_groups:
            ...
            if isinstance(kv_cache_group.kv_cache_spec, AttentionSpec):
                ...
                continue
        num_attn_blocks = (available_memory - linear_memory_size * num_linear_blocks) // attn_page_size_bytes
        ...
        for i in range(len(kv_cache_groups)):
            ...
            elif isinstance(kv_cache_groups[i].kv_cache_spec, AttentionSpec):
                tensor_size = kv_cache_groups[i].kv_cache_spec.page_size_bytes * num_linear_blocks
                num_blocks = num_linear_blocks
            else:
                continue
            for layer_name in kv_cache_groups[i].layer_names:
